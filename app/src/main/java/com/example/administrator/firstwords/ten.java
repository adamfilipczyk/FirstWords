...
public class ten extends Activity implements View.OnTouchListener, View.OnDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //player
        mMediaPlayer = MediaPlayer.create(this, R.raw.ten);
        mMediaPlayer.start();


        //object for the speaker sound
        sound = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
        soundID = sound.load(this, R.raw.ten, 1);
        ...
        //letters
        findViewById(R.id.ten_t).setOnTouchListener(this);
        findViewById(R.id.ten_e).setOnTouchListener(this);
        findViewById(R.id.ten_n).setOnTouchListener(this);
    ...
    public void check (View view) {
        ...
        ImageView t = (ImageView) b_t.findViewById(R.id.ten_t);

        LinearLayout b_e = (LinearLayout)findViewById(R.id.bottom_e);
        ImageView e = (ImageView) b_e.findViewById(R.id.ten_e);

        LinearLayout b_n = (LinearLayout)findViewById(R.id.bottom_n);
        ImageView n = (ImageView) b_n.findViewById(R.id.ten_n);
