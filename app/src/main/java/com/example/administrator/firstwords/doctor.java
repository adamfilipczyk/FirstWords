 ...
 */
public class doctor  extends Activity implements View.OnTouchListener, View.OnDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //player
        mMediaPlayer = MediaPlayer.create(this, R.raw.doctor);
        mMediaPlayer.start();


        //object for the speaker sound
        sound = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
        soundID = sound.load(this, R.raw.doctor, 1);
        ...
        //letters
        findViewById(R.id.doctor_d).setOnTouchListener(this);
        findViewById(R.id.doctor_o).setOnTouchListener(this);
        findViewById(R.id.doctor_c).setOnTouchListener(this);
        findViewById(R.id.doctor_t).setOnTouchListener(this);
        findViewById(R.id.doctor_o2).setOnTouchListener(this);
        findViewById(R.id.doctor_r).setOnTouchListener(this);
    ...
    public void check (View view) {
        ...
        ImageView d = (ImageView) b_d.findViewById(R.id.doctor_d);

        LinearLayout b_c = (LinearLayout)findViewById(R.id.bottom_c);
        ImageView c = (ImageView) b_c.findViewById(R.id.doctor_c);

        LinearLayout b_t = (LinearLayout)findViewById(R.id.bottom_t);
        ImageView t = (ImageView) b_t.findViewById(R.id.doctor_t);

        LinearLayout b_r = (LinearLayout)findViewById(R.id.bottom_r);
        ImageView r = (ImageView) b_r.findViewById(R.id.doctor_r);


        //o---------------------------------------------------------

        LinearLayout b_o = (LinearLayout)findViewById(R.id.bottom_o);
        ImageView o1 = (ImageView) b_o.findViewById(R.id.doctor_o);

        LinearLayout b_o2 = (LinearLayout)findViewById(R.id.bottom_o2);
        ImageView o2 = (ImageView) b_o2.findViewById(R.id.doctor_o2);

        LinearLayout b_o3 = (LinearLayout)findViewById(R.id.bottom_o);
        ImageView o3 = (ImageView) b_o3.findViewById(R.id.doctor_o2);

        LinearLayout b_o4 = (LinearLayout)findViewById(R.id.bottom_o2);
        ImageView o4 = (ImageView) b_o4.findViewById(R.id.doctor_o);
                ...
                case 1:
                    ...
                    correct1.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        public void onCompletion(MediaPlayer mp) {
                            mp.release();
                            finish();
                            Intent farmer = new Intent(getApplicationContext(), farmer.class);
